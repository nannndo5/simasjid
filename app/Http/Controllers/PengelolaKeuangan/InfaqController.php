...
class InfaqController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('pengelola-keuangan.infaq.index', compact('infaqs', 'totalPemasukan', 'rekenings'));
    }
    ...
    {
        return view('pengelola-keuangan.infaq.create');
    }
    ...
    {
        return view('pengelola-keuangan.infaq.show', compact('infaq'));
    }
    ...
    {
        return view('pengelola-keuangan.infaq.edit', compact('infaq'));
    }
