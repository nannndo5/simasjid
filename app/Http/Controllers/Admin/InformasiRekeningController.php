...
class InformasiRekeningController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.informasi-rekening.index', compact('rekenings'));
    }
    ...
    {
        return view('admin.informasi-rekening.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.informasi-rekening.index')
    ...
    {
        return view('admin.informasi-rekening.show', compact('informasiRekening'));
    }
    ...
    {
        return view('admin.informasi-rekening.edit', compact('informasiRekening'));
    }
