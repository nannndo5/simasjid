@php
$title = 'TPQ';
$description = 'Taman Pendidikan Al-Quran Islamic Center';
@endphp
...
<x-layouts.public :title="$title" :description="$description">
    ...
    <section class="bg-gradient-to-r from-green-600 to-green-700 text-white py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 class="font-heading text-4xl md:text-5xl font-bold mb-4">TPQ</h1>
            <p class="text-xl text-green-100 max-w-2xl">
                Taman Pendidikan Al-Quran Islamic Center
            </p>
        </div>
    </section>

    <!-- TPQ Content Section -->
    <section class="py-12 md:py-16 bg-white" aria-labelledby="tpq-heading">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-4xl mx-auto">
                <h2 id="tpq-heading" class="font-heading text-3xl md:text-4xl font-bold text-navy-900 mb-8 text-center">
                ...
                @empty
                    <div class="text-center py-12">
                        <p class="text-navy-600 text-lg">Belum ada data TPQ.</p>
                    </div>
                @endforelse
            </div>
        </div>
