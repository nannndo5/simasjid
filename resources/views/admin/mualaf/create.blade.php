<x-layouts.dashboard title="Tambah Data Mualaf">
    <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
        <div class="bg-gradient-to-r from-green-600 to-green-700 px-6 py-4">
            <h3 class="text-xl font-bold text-white">Tambah Data Mualaf Baru</h3>
        </div>
        
        <div class="p-6">
            <form action="{{ route('admin.mualaf.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
