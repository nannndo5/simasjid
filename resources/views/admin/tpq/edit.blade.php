<x-layouts.dashboard title="Edit Data TPQ">
    <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
        <div class="bg-gradient-to-r from-indigo-600 to-indigo-700 px-6 py-4">
            <h3 class="text-xl font-bold text-white">Edit Data TPQ</h3>
        </div>
        
        <div class="p-6">
            <form action="{{ route('admin.tpq.update', $tpq) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                @method('PUT')
                    ...
                    <div class="md:col-span-2">
                        ...
                        @if($tpq->gambar)
                            <div class="mb-4">
                                ...
                                <img src="{{ Storage::url($tpq->gambar) }}" alt="TPQ" class="h-48 w-auto rounded-lg border border-gray-300">
                            </div>
                        @endif
                ...
                <div class="flex justify-end space-x-3 pt-4 border-t border-gray-200">
                    <a href="{{ route('admin.tpq.index') }}" class="inline-flex justify-center items-center px-5 py-2.5 border border-gray-300 shadow-sm text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors">
                        Batal
                    </a>
